...
ko = LINETCR.LINE()
ko.login(token="Eq972I44RgxpLL3chC63.o2XXqY54uxyx4WHdWleLeW.z1fkmH0vqyVE5aGpUkOagPjOnt6volg+hGVXsWvqYyk=")

ke = LINETCR.LINE()
ke.login(token="EqtZsBwCPHMefbdQxWH4.0aPixyJFVtPGnatN+0kpja.vZFWL+km5u5SSczAM7fseCfDZt1kbJVTsXRCE4/KFz4=")

ku = LINETCR.LINE()
ku.login(token="EqN9lwfrSpDXhzofVDP4.mltN4OiQZ5b5VUy8HPrkfa.Y5wtUIRrKF7VV8tYe7f107zMynH3RSeCVhnJ+7kZQl8=")
...
-- Namelock on/off
"""
KAC=[cl,ki,kk,kc,ks,km,kt,ko,ke,ku]
DEF=[ki,kk,kc,ks,km,kt,ko,ke,ku]

...
cl = LINETCR.LINE()
cl.login(token="masukin tokenmu disini bego")

ki = LINETCR.LINE()
ki.login(token="masukin token asismu pea")

kk = LINETCR.LINE()
kk.login(token="masukin token asismu pea")

kc = LINETCR.LINE()
kc.login(token="masukin token asismu pea")
...
Bots=[mid,Amid,Bmid,Cmid,mid smua asistmu pea]

...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='ErPlba2LVpSWP9bV8KN9.OUBK+zA36qOR1IdugNZIMq.lY6rfDZ5ekCTXkCu74+AmoF4QeicgOHvbdiqLHJTe94=')
nadya.loginResult()
...
Bots=["ua2e6e4fd96b7e90a2bd620d41a7ce299"]
Creator=["ua2e6e4fd96b7e90a2bd620d41a7ce299"]
admin=["ua2e6e4fd96b7e90a2bd620d41a7ce299"]

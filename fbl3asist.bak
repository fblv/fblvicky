...
cl = LINETCR.LINE()
cl.login(token="EpMei23tzcrtOQDryGia.OUJk2OaZK4HA5Ypnn2aaoG.7Zsag9MEFbRiT4uBUJ9uCt7TVoBqSfvxCaBy12+i7AE=")

ki = LINETCR.LINE()
ki.login(token="Ep8TrYxXPBhqbuiLH387.Dh8gAYzI7J+lfj1J6Drm5W.W3yOCBZEXdb1hbbKrCWHRqXYQAjpV8bIHJF79fUOAMg=")

kk = LINETCR.LINE()
kk.login(token="EpoJ9Oea1JN0VB5TM9u3.qDz/HqrUPAshUb/OBwJ7CW.FXo3BNBfbZnYo9cKO36WhhFCiLfv81WTykBRYIpBOHA=")

kc = LINETCR.LINE()
kc.login(token="EpCZG5PsU9zDI9y2JP1b.GcMK/mE4QSBwCGlHYZjp/W.qu/iQFs4WZKIczUM2s8XW1OcrY0veHJaRhpJIvhhqR4=")

ks = LINETCR.LINE()
ks.login(token="EpVasBtBWTD5xYvczQk4.td1frUeRlzHX3ONMwzlFHa.jsnzNvdBBZWtSMLvmINyd4Gjbdn1wjw96TWAjBixA1Y=")

kt = LINETCR.LINE()
kt.login(token="EpR9VLlrwVEtHybBSpEd.9sQ3gy64b+cuzcMzBI7NBq.KYig98ViPEz9zKdkWlmEpqa1oG/T7t2rqIRCvKWTh1A=")
...
helpMessage =""" 🔯Pasukan グループ  混雑 BOT Menu V.3  􀔃􀄆red check mark􏿿
...
➡[Cekon🔀Cekoff]
         ...
         🔯My Creator : By 👻Untul27👻 http://line.me/ti/p/egQaYIQMhd
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Fmid,"u1b25e445c29e71eb0e82724efdde5ac6","u9f9e6ce68d40a7807b605fd82701959f","ua2e8cada803393885ae723cd3760003a","u747f066b2662ee3fcb149d63e9d44ce7","u41d67e85046ea5a487b81fa86d68fb73","u81397a05609829de55eb766785b07fe3","u4c3d4546e12b2d9871de89e65992df84","uf52ab7198eb807f0946429996e2ee76d"]
admin=["u9f9e6ce68d40a7807b605fd82701959f","u1b25e445c29e71eb0e82724efdde5ac6"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    try:
        ...
        if op.type == 19:
          if wait["protection"] == True:
                if not op.param2 in Bots + admin:
                    try:
        ...
        if op.type == 26:
            ...
            elif "Wkick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("Wkick ","")
            ...
            elif "Winvite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("Winvite ","")
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Bye 2","Ciblek hus"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye 3","Brindil hus"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye 4","Kadal hus"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye 5","Bawor hus"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        pass
            elif msg.text in ["Bye 6","Dudul hus"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#------------------------------- Kerang Ajaib -------------------------------
                ...
                rnd = ['Ya','Tidak','Bisa Jadi','Mungkin Saja']
                p = random.choice(rnd)
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Assalamu'alaikum.Wr,Wb")
...
#----------------------------------------------------------------------------
        #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,"Pasukan グループ  混雑 Absen")
                cl.sendText(msg.to,"グループ  混雑 1 hadir..")
                ki.sendText(msg.to,"グループ  混雑 2 hadir...")
                kk.sendText(msg.to,"グループ  混雑 3 hadir....")
                kc.sendText(msg.to,"グループ  混雑 4 hadir.....")
                ks.sendText(msg.to,"グループ  混雑 5 hadir......")
                kt.sendText(msg.to,"グループ  混雑 6 hadir.......")
      #-------------Fungsi Respon Finish---------------------#
            elif msg.text.lower() == 'Pasukan':
              if msg.from_ in admin:
                cl.sendText(msg.to, "Cek Pasukan!")
                profile = cl.getProfile()
                ...
                ks.sendText(msg.to, "Pasukan Lengkap")
...
#=================================================
                ...
                if msg.from_ in admin:
                    ...
                    try:
                        ...
                        ks.sendText(msg.to, "Kagebunshin No Jutsu5")
                    except Exception as e:
                                print e 
            elif "Kagebunshin6 " in msg.text:
                if msg.from_ in admin:
                    midd = eval(msg.contentMetadata["MENTION"])
                    mata = midd["MENTIONEES"][0]["M"]
                    try:
                        kt.CloneContactProfile(mata)
                        kt.sendText(msg.to, "Kagebunshin No Jutsu5")
                    except Exception as e:
                                print e 
#-----------------------------------------------      
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        cl.sendText(op.param1, 'ciee ngintip😅 kak ☞ '+nick[0]+' ☜\nNgapain Kak Ngintip Aja???\nSini Gabung Chat...   ')
                                        cl.sendImageWithURL(op.param1, path)
                                    else:
                                        cl.sendText(op.param1, 'Haii 😅 Kak ☞ '+nick[1]+'☜\nEhem... ngintip aja kamu??\nSini Gabung Chat...  ')
                                        cl.sendImageWithURL(op.param1, path)
                                else:
                                    cl.sendText(op.param1, 'Salken 😅 kak ☞ '+Name+'☜\nNgintip Aja Niih. . .\nChat Dong Sini (-__-)   ')
                                    cl.sendImageWithURL(op.param1, path)
                        else:
                            cl.sendText(op.param1, 'ciee ngintip 😅 kak ☞ '+nick[0]+' ☜\nBetah Banget Jadi Penonton. . .\nChat Napa (-__-)   ')
                            cl.sendImageWithURL(op.param1, path)
                    else:
                        cl.sendText(op.param1, ' Hai 😅 kak ☞ '+Name+' ☜\nBetah amat Ngintip aja . .\nChat Kek Idiih (-__-)   ')
                        cl.sendImageWithURL(op.param1, path)
                except:
                    pass

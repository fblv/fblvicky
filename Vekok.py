...
ki = LINETCR.LINE()
ki.login(token="ErO55zPWKoxhGyt8asH4.mltN4OiQZ5b5VUy8HPrkfa./NHZ8LLNIQYF7cZ7Em9fCcImYhZ0Jw24x0BMLSswjSY=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="ErTfHCtOOPwZV3yWTpC8.yeeFkYzvwhoWJ52woLDjQa.vk7hMvKxMgG/YG2Q//Fx3f/0nm2SIJB0t7JNrPM19oA=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Erwcl5bxIzEnjVDMONia.PofXftRniBZHiiLLYC37sG.XBgD9AJcjnF9qLeGzWNlTFL6wDN/NJp9rmCVPNDw16s=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="EryJvu7ov1E2RjnwlMH3.AI9R5QXoLIki841eZJRGWW.cUAQjnxUQH//DvTNMUgQtkqQj4QAlgYFYrl1LUJ+ZUg=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="ErTKxVUnLSG3KLV1qu0b.fJ/2OzZsyqO7vs6/M3oIQW.su3CcA/WHFSKh3XlrPKq5g5V5Wmdxr7rjnqF7/yiXJo=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="ErrO619tp0T2r13g1HFf.w2y3st77l8p+Bfx9XcVvtW.+NA9SO9J3+zJg+gH1CRILkp5isXr3ymekDS1LCsA600=")
ke.loginResult()

kh = LINETCR.LINE()
kh.login(token="Er4MPrQQugFhYmI4VvNc.dmwV+8AvfCg9qISHOhivVa.yk81GmWrsPtCBGThwb05/5X1EgD3w1vsMyoajqxoQj0=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="ErCw8P4Ils3GwYJxlSkf.bMxsVktNlf4/LlMU1msQZW.sxByvcWIDPGqMQPuzDKqnOW7B4GvXVgaR9WmCk7CN4w=")
kj.loginResult()

kf = LINETCR.LINE()
kf.login(token="Erjcyiy250g0uRgCvs53.o2XXqY54uxyx4WHdWleLeW.GPcCuaV3sYFV5esrajh+2iTnUOuLztmXlwLcTimapyQ=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="ErC77gWMMjmYkS9Rvwg4.0aPixyJFVtPGnatN+0kpja.UUkWkFdrzQ3MdZFjlKqFxho3sRsnr4QCvESUC7tDUcQ=")
kg.loginResult()
...
helpMessage ="""  ✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks for add Created ✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️",
    "lang":"JP",
    "comment":"🔹Auto like by ☞ ✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️",
    "likeOn":True,
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
...
#------------------------[Welcome]----------------------------
        ...
        if op.type == 15:
            if op.param2 in admin:
                return
            cl.sendText(op.param1, "Baper ya kak!!? 🙄 Hapus Akun aJa 😂 malu sama umur")
            print "MEMBER HAS LEFT THE GROUP"
#-------------------------------------------------------------------- 
        if op.type == 11:
            if not op.param2 in Bots:
...
#-----------------------------------------------
                ...
                N.sendText(msg.to,"Yang penting Sombong BoosQuw 😎")
#-----------------------------------------------
            elif "V " in msg.text:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Hadir Vicky Sayang 😘")
                kk.sendText(msg.to,"Stay wht u V҉i҉c҉k҉y 😘")
                kc.sendText(msg.to,"Ada Buat vicky ")
                kb.sendText(msg.to,"Yang Penting Sombong 😘")
                kd.sendText(msg.to,"")
                ke.sendText(msg.to," 😍 iya vicky")
                kg.sendText(msg.to,"Miss u pick 😚")
                kh.sendText(msg.to,"😍😍 Apa yg nggak buat mu")
                kj.sendText(msg.to,"Love Tok piki 😘😘")
                kf.sendText(msg.to,"Miss U piki ku 😍")
                kf.sendText(msg.to,"======[ 😍 Done vicky Sayang ]======")

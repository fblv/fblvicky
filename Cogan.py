...
cl = LINETCR.LINE() #fblvicky
#cl.login(qr=True)
cl.login(token="EqTEzycbAYaCN8M8P7Zc.KBtylGF7T07g2h8DyG87Ja.LjWTm+j9brDecf9GhocpIZDcOn/6KxQ65pT1zbwVAkY=")
cl.loginResult()

ki = LINETCR.LINE() #Shavira
#ki.login(qr=True)
ki.login(token="Eq6xCLlMD43rK8jy2pf0.fKd67QAsv3/e/1ZBy+8pea.jcIDuVZlEhOb+drjkfKWWvZYLNhdKLpkYox8uaua+cY=")
ki.loginResult()

kk = LINETCR.LINE() #Melody
#kk.login(qr=True)
kk.login(token="Eq9ZiVWLTzYQrFOtLyL8.yeeFkYzvwhoWJ52woLDjQa.TEkRLbCeD5o8h7iQxKDxw05SHUAx9f0239pUdwmyZsc=")
kk.loginResult()

kc = LINETCR.LINE() #Nabilla
#kc.login(qr=True)
kc.login(token="Eq140BnOnrjardWSKeka.PofXftRniBZHiiLLYC37sG.E7rqcN4GUE8TtrPQHGreXL68/TVRZjbcUacljdnWi1Q=")
kc.loginResult()

ks = LINETCR.LINE() #Jesica
#ks.login(qr=True)
ks.login(token="EqdYIqzvbUSchtvrh1e3.AI9R5QXoLIki841eZJRGWW.1+qbqDhpqjoNRf1rqP8uux0pNkHk/RWqAlHm60KEFnc=")
ks.loginResult()

k1 = LINETCR.LINE() #Muchele
#k1.login(qr=True)
k1.login(token="EqufPUEGBuxWR2VVIQOb.fJ/2OzZsyqO7vs6/M3oIQW.t4qm1JkcZmkM06c62I7NnqR19gZd0tVh3pTx+C7IFrA=")
k1.loginResult()

k2 = LINETCR.LINE() #Naomi
#k2.login(qr=True)
k2.login(token="Eqsstw0tcrJE6U2SGy1f.w2y3st77l8p+Bfx9XcVvtW.9ZrsNJ6rZgkrBXKG10OPiJqgl0/jWmnfRMtz2hTpBN4=")
k2.loginResult()

k3 = LINETCR.LINE() #viyona
#k3.login(qr=True)
k3.login(token="EqLaWUVtvWNeTWBLh8cc.dmwV+8AvfCg9qISHOhivVa.kJdyL8NrEvoK5OtwFFpWrWIkcw+thTu6FyCI/OYgip0=")
k3.loginResult()

k4 = LINETCR.LINE() #toneri
#k4.login(qr=True)
k4.login(token="Eq7UxJfOSY0FHTMQrHzf.bMxsVktNlf4/LlMU1msQZW.AHpw7nYxOvSi+97irKfMkaCiv6t0o4DZaVX2GgIyOxE=")
k4.loginResult()

k5 = LINETCR.LINE() #orocimaru
#k5.login(qr=True)
k5.login(token="Eq972I44RgxpLL3chC63.o2XXqY54uxyx4WHdWleLeW.z1fkmH0vqyVE5aGpUkOagPjOnt6volg+hGVXsWvqYyk=")
k5.loginResult()

satpam = LINETCR.LINE() # madara
satpam.login(token="EqtZsBwCPHMefbdQxWH4.0aPixyJFVtPGnatN+0kpja.vZFWL+km5u5SSczAM7fseCfDZt1kbJVTsXRCE4/KFz4=") 
...
helpMessage ="""=࿅ོ࿆༼✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️༽࿅ོ࿆=
=========================
...
========================
"""
Keyowner ="""=࿅ོ࿆༼✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️༽࿅ོ࿆=
=========================
...
========================
"""
Setgroup ="""=࿅ོ࿆༼✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️༽࿅ོ࿆=
=========================
...
["u91b4d82e07fbb74ec6d87f1d620f3b8c"]
Amid = ki.getProfile().mid
["u1640faeea692577f84fb5cdb63ff0f10"]
Bmid = kk.getProfile().mid
["u60411f2b26555873b08f9d963a5749a8"]
Cmid = kc.getProfile().mid
["ua4e171153acd21bce1208965c9cdfb4a"]
Dmid = ks.getProfile().mid
["u6a2f6be6ac4e962288f38d44ce3ae0c3"]
Emid = k1.getProfile().mid
["u163fb6a19cd2610a3b552ebe9b73a2ab"]
Fmid = k2.getProfile().mid
["u5b6637493efb2fc3ff6c55fdc42bd54f"]
Gmid = k3.getProfile().mid
["u0cc5afffc69515c1bd422b21a07215bc"]
Hmid = k4.getProfile().mid
["u0665d2bca4e72c5e3e94b9aed4c4aacf"]
Imid = k5.getProfile().mid
["u3b6c71432e78517617e30843c0b12513"]
Smid = satpam.getProfile().mid
["ud00a485d88dfbd3a603404e7ff428f24"]
...
induk=["u91b4d82e07fbb74ec6d87f1d620f3b8c"]
Creator=["u91b4d82e07fbb74ec6d87f1d620f3b8c","u1640faeea692577f84fb5cdb63ff0f10"]
admin=["u91b4d82e07fbb74ec6d87f1d620f3b8c","u1640faeea692577f84fb5cdb63ff0f10"]
owner=["u91b4d82e07fbb74ec6d87f1d620f3b8c","u1640faeea692577f84fb5cdb63ff0f10"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Nah Thanks for add me 😊",
    "lang":"JP",
    "comment":"✝️  F҉bL҉ 􀌂􀄠􀌂􀄠 V҉ic҉ky҉҉  ✝️",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,

...
cl = LINETCR.LINE()
cl.login(token="isi tokenmu bego")

ki = LINETCR.LINE()
ki.login(token="isi token asismu pea")

#kk = LINETCR.LINE()
#kk.login(token="EoFPNNoG3z2werd5tzv7.AP7ySLs73cxNOjliqYKBDW.jQ34eFB9X6JSrpMuuab0UAKnPj+P00KKjcJkxanSdmc=")

#kc = LINETCR.LINE()
#kc.login(token="EoFPNNoG3z2werd5tzv7.AP7ySLs73cxNOjliqYKBDW.jQ34eFB9X6JSrpMuuab0UAKnPj+P00KKjcJkxanSdmc=")

#ks = LINETCR.LINE()
#ks.login(token="EnxLbaAjOMnHixHT46ld.SvY+nl5NzliKO8GAJ/4NRq.IwU/+VQ+G//lF7TmHeW+gJW0ZTMIaFsrgQuk5HvSJBU=")
...
Bots=[mid,Amid,"masukin mid lu + asis"]
admin=["mid lu pea"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "lang":"JP",
    "tag":True,
    "comment":"Auto Like By :F҉bL҉ V҉ic҉ky҉҉ ",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
              if wait ["tag"] == True:
                    ...
                    balas = ["Dont tag me, im busy",cName + " ada apa ngetag?",cName + " PM AJA",cName + "apa😕-_-",cName]

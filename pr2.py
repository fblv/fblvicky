...
acil = PRANKBOTS.LINE() 
acil.login(token="Er0ZYl19S30gMr0JTnl0.fKd67QAsv3/e/1ZBy+8pea.NCkzTE1Jh70Hu7DJSwwRl91nFbbJnuz1bJ6IP/r/Vzw=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="ErO55zPWKoxhGyt8asH4.mltN4OiQZ5b5VUy8HPrkfa./NHZ8LLNIQYF7cZ7Em9fCcImYhZ0Jw24x0BMLSswjSY=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="Erjcyiy250g0uRgCvs53.o2XXqY54uxyx4WHdWleLeW.GPcCuaV3sYFV5esrajh+2iTnUOuLztmXlwLcTimapyQ=")
pb2.loginResult()
...
helpMessage ="""(╣••в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́••╣)
╔═══F༘༘̈́̈́B༘̈́̈́L༘̈́̈́  ̈́V༘̈́̈́IC༘̈́̈́K༘̈́̈́Ÿ༘́═╗
║Me
║Add
║Cn "text"
║Clockname "text"
...
║Procancel:on/off
╚══════════╝
(╣•̰̰̈́в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́•╣)
"""
helo="====I AM •̰̰̈́в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́•"

KAC=[acil,pb1,pb2]
mid = acil.getProfile().mid
pb1mid = pb1.getProfile().mid
pb2mid = pb2.getProfile().mid
Bots=[mid,pb1mid,pb2mid,"u1640faeea692577f84fb5cdb63ff0f10"]
admsa = "u1640faeea692577f84fb5cdb63ff0f10"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""❂••••AUTO ADD BY F༘༘̈́̈́B༘̈́̈́L༘̈́̈́  ̈́V༘̈́̈́IC༘̈́̈́K༘̈́̈́Ÿ༘́ •в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́•••••❂""",
    "lang":"JP",
    "comment1":"❂••••AUTO ADD BY F༘༘̈́̈́B༘̈́̈́L༘̈́̈́  ̈́V༘̈́̈́IC༘̈́̈́K༘̈́̈́Ÿ༘́ •в̰̰̈́ä̰̰́т̰̰̈́❍ṵ̰̰̈́s̰̰ä̰̰̰́ḭ̰̰̈́•••••❂",
